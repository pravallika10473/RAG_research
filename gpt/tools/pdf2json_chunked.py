...
class PDFProcessor:
    ...
    async def process_pdf(self, pdf_path, doc_id, start_number, progress_task=None, progress=None):
        ...
        document = {
            ...
            "chunks": chunks,
            "images": images,
            "pdf_path": pdf_path  # Add PDF path to document structure
        }

        return document, len(images)
# In pdf2json_chunked.py

async def main(pdf_files, output_path="../finalAgent_db/documents.json", image_dir="../finalAgent_db/images"):
    """
...
if __name__ == "__main__":
    pdf_path = "../finalAgent_db/papers/paper13.pdf"
